...
class ActionNetwork(nn.Module):
    ...
    def forward(self, state: torch.tensor, start: torch.tensor, end: torch.tensor) -> torch.tensor:
        ...
        end_features = node_embeddings[end]
...
class Agent:
    ...
    def __init__(self, state_shape: tuple, action_size: int, state_high: pd.DataFrame):
        ...
        self.action_nn = ActionNetwork(self.n_nodes, self.action_size, self.embedding_size)
    ...
    def save_models(self) -> None:
        ...
        :return: None
        """
        torch.save(self.action_nn.state_dict(), './models/action_embednet.pth')
        torch.save(self.end_nn.state_dict(), './models/end_embednet.pth')
    ...
    def load_models(self) -> None:
        ...
        :return: None
        """
        self.action_nn.load_state_dict(torch.load('./models/action_embednet.pth'))
        self.end_nn.load_state_dict(torch.load('./models/end_embednet.pth'))
